...
func Try2[A any](a A, err error) (A) {
	Try(err)
	return a
}
...
func Try4[A, B, C any](a A, b B, c C, err error) (A, B, C) {
	Try(err)
	return a, b, c
}

// Try5 - if err is not nil, calls handler.
func Try5[A, B, C, D any](a A, b B, c C, d D, err error) (A, B, C, D) {
	Try(err)
	return a, b, c, d
}
